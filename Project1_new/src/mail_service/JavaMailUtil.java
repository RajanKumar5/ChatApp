...
public class JavaMailUtil {
	public static void sendMail(String reciepient, String sub, String msg) throws Exception{
		...
		String myAccountEmail = "email-id@gmail.com";
	...
	private static Message prepareMessage(Session session, String myAccountEmail, String reciepient, String sub, String msg) {
		try{
