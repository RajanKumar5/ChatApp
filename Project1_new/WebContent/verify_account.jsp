...
<html lang="en">
  <head>
    ...
    <title>Verify Mail|ChatApp</title>
    <style type="text/css">
     body{
      ...
      <div class="col-lg-5 m-auto">
        <div class="card mt-5 bg-dark">
          <div class="card-title text-center text-white">
            <h3 class="pt-2">OTP has been send to your Email Address , Enter the OTP and verify your account.</h3>
            <hr>
            <div class="card-body">
        ...
        <button type="submit" class="btn btn-primary btn-sm">Verify Mail</button><br>
        <p class="text-white mt-2"><a href="resend-otp">Resend OTP</a></p>
      </div>
            </form>
          </div>
          </div>
